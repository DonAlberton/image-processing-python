...
def classify_given_image(image):
    ...
    conatins_glasses = True if glasses_filter(image)[1] == 'Z okularami' else False

    has_face = face_detection(image)[1]
    image_classification = {'isWinter': is_winter, 'isBeach': is_beach, 'isIndoor': is_indoor, 'hasFace': has_face, 'glasses': conatins_glasses}
